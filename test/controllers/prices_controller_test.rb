...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { call_center: @price.call_center, finance: @price.finance, it: @price.it, logistics: @price.logistics, marketing: @price.marketing, technology: @price.technology } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { call_center: @price.call_center, finance: @price.finance, it: @price.it, logistics: @price.logistics, marketing: @price.marketing, technology: @price.technology } }
